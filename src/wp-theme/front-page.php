...
<main>
  ...
  <div class="inner">
    ...
    <p class="text">
      ...
      「宗教なのか？」「怖い人がいるのでは？」
      「強引な勧誘をされたらどうしよう」
      などなど、さまざまな不安を感じている方もいると思います。
      実際の会場の雰囲気や活動内容、加入されているメンバーのこと、
      ありのままをお伝えします。
    </p>
    <a href="#" class="button">Read more<div class="button__icon">
        <svg class="button__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="13" viewBox="0 0 25 13">
          <defs>
            <clipPath id="a">
          ...
          <g transform="translate(-638 -975.248)">
            <ellipse class="button__svg-ellipse" cx="4.5" cy="5" rx="4.5" ry="5" transform="translate(638 977.248)" fill="#c38b79" opacity="0.5" />
    ...
    <a href="#" class="button--blue">Read more
    ...
    <a href="#" class="button--white">Read more<div class="button__icon">
        <svg class="button__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="13" viewBox="0 0 25 13">
          <defs>
            <clipPath id="a">
              <rect width="13" height="20" transform="translate(0 0.258)" fill="none" stroke="#c38b79" stroke-width="1" />
    ...
    <a href="#" class="button--ocher">Read more<div class="button__icon">
        <svg class="button__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="13" viewBox="0 0 25 13">
          <defs>
            <clipPath id="a">
              <rect width="13" height="20" transform="translate(0 0.258)" fill="none" stroke="#c38b79" stroke-width="1" />
